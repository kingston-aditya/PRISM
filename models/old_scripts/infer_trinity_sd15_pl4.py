...
from pipeline1 import ProjectLayer
...
def main(args):
    ...
    proj_layer = accelerator.prepare(proj_layer)
    ...
    for step, batch in enumerate(tqdm(train_dataloader, desc="Inferring")):
        ...
        images = pipeline(prompt_embeds=trinity_embeds, num_inference_steps=50, unet=unet, num_images_per_prompt=args.num_validation_images).images
