...
def make_message_qwen(batch, num):
    ...
    for prt in batch:
        ...
        cont3_q = "Give 2 paraphrased prompts for the following prompt: Change the background to a hilly area. \n\n Output - Change the background to mountaineous area. \n The background should be changed to hilly area."
        cont4_q = "Give 3 paraphrased prompts for the following prompt: Remove the tower from the bridge. \n\n Answer - The tower near the bridge should be removed. \n Delete the tower near the bridge. \n The tower near the bridge should be deleted."
        cont5_q = "Give 2 paraphrased prompts for the following prompt: Add a brown cat near the dog. \n\n Answer - A brown cat should be added near the dog. \n Include a brown cat near the dog."
...
if __name__ == "__main__":
    ...
    for name in glob.glob(os.path.join(args["dataset_name"],"metadata*.jsonl")):
        ...
        with open(os.path.join(args["dataset_name"], name.split(".")[0]+"_n"+".jsonl"), "w") as f:
