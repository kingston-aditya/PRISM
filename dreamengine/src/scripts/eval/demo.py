...
OUTPUT_PATH = "/nfshomes/asarkar6/aditya/PRISM/dreamengine/src/gen_images/"
...
def generate_image(image1, image2, caption1, caption2, text_prompt, cfg_scale, size, num_steps, seed):
    ...
    # segments = ([caption1,obj_transform(image1)], )

    output = pipeline.cfg_predict(prompt=text_prompt,segments=segments, num_inference_steps=num_steps,num_images_per_prompt=1,width=size,height=size, guidance_scale=cfg_scale, max_sequence_length=256)
