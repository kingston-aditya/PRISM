...
accelerate launch --num_processes 2 --num_machines 1 --mixed_precision bf16 --zero_stage 2 /nfshomes/asarkar6/aditya/PRISM/dreamengine/src/scripts/train/train.py \
