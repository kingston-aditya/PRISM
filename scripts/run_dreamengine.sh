export DATASET_CONFIG="/fs/cml-datasets/coco/annotations/captions_val2017.json"
...
accelerate launch --main_process_port 29501 /nfshomes/asarkar6/aditya/PRISM/dreamengine/src/scripts/train/new_train.py \
  ...
  --cfg_ratio=0.1 \
  --num_latents=256 \
  --resume_from_checkpoint="/nfshomes/asarkar6/trinity/model_weights/DreamEngine-ObjectFusion/transformer/"