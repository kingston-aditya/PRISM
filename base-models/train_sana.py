...
from dataset.trinity_dataloader import PixartTrainDataset
...
def main(args):
    ...
    if args.optimizer.lower() == "adamw":
        ...
        raise ValueError("This script supports only Adam optimizer.")
    ...
    if not precomputed_dataset.custom_instance_prompts:
    ...
    if accelerator.is_main_process:
        tracker_name = "trinity-sana-lora"
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(models_to_accumulate):
                ...
                # if precomputed_dataset.custom_instance_prompts:
